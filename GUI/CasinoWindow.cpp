...
void CasinoWindow::setupUI() {
    ...
    this->ui.toolButtonRouletteBet1->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet2->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet3->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet4->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet5->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet6->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet7->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet8->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet9->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet10->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet11->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet12->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet13->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet14->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet15->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet16->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet17->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet18->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet19->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet20->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet21->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet22->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet23->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet24->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet25->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet26->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet27->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet28->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet29->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet30->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet31->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet32->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet33->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet34->setStyleSheet(QString(styleSheetRed.c_str()));
    this->ui.toolButtonRouletteBet35->setStyleSheet(QString(styleSheetBlack.c_str()));
    this->ui.toolButtonRouletteBet36->setStyleSheet(QString(styleSheetRed.c_str()));
}
